...
**Estado actual**: Fases 0, 1, 2, 3, 4C, 5A, 5B, 6, 7A, 7B-1, 7B-2, 7B-3, 7C-1, 7C-2A, 7C-2B, 7D-1, 7D-2, 7E-1, 7E-2, 7E-3 y 7F-1 completadas. Siguiente foco: pantalla de competición activa con webcam, performance, seguridad y preparación de deployment.
